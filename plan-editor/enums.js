window.enums = {
	...
	room_type: [
		...
		{e: 'windmill', n: 'Windmill', c: 'Utility', fh: 3, fw: 3}
	],
	corridor_type: [
	...
	layout_type: [
		...
		{e: 'bed', n: 'Bed', c: 'Furniture', mr: true, ch: 'Θ'},
		{e: 'chair', n: 'Chair', c: 'Furniture', mr: true, ch: '╥'},
		{e: 'table', n: 'Table', c: 'Furniture', mr: true, ch: '╤'},
		{e: 'statue', n: 'Statue', c: 'Furniture', mr: true, ch: 'Ω'},
		{e: 'chest', n: 'Chest', c: 'Storage', mr: true, ch: 'Æ'},
		{e: 'cabinet', n: 'Cabinet', c: 'Storage', mr: true, ch: 'π'},
		{e: 'bookcase', n: 'Bookcase', c: 'Storage', inv: true, ch: '≡'},
		{e: 'archery_target', n: 'Archery Target', c: 'Military', ch: 'X'},
		{e: 'armor_stand', n: 'Armor Stand', c: 'Military', mr: true, ch: '♫'},
		{e: 'weapon_rack', n: 'Weapon Rack', c: 'Military', mr: true, ch: '√'},
		{e: 'cage', n: 'Cage', c: 'Restraints', mr: true, inv: true, ch: '‼'},
		{e: 'restraint', n: 'Chain', c: 'Restraints', mr: true, ch: '§'},
		{e: 'hive', n: 'Hive', c: 'Farm', ch: '▬'},
		{e: 'nest_box', n: 'Nest Box', c: 'Farm', inv: true, ch: '◘'},
		{e: 'coffin', n: 'Coffin', c: 'Utilities', mr: true, ch: '0'},
		{e: 'traction_bench', n: 'Traction Bench', c: 'Utilities', ch: 'Φ'},
		{e: 'well', n: 'Well', c: 'Utilities', mr: true, ch: '○'},
		{e: 'door', n: 'Door', c: 'Gates', inv: true, ch: '┼'},
		{e: 'hatch', n: 'Hatch', c: 'Gates', ch: '¢'},
		{e: 'cage_trap', n: 'Cage Trap', c: 'Traps', ch: '^'},
		{e: 'lever', n: 'Lever', c: 'Machines', ch: 'ò'},
		{e: 'roller', n: 'Roller', c: 'Machines', ch: '╢'},
		{e: 'track_stop', n: 'Track Stop', c: 'Machines', inv: true, ch: '≡'},
		{e: 'vertical_axle', n: 'Vertical Axle', c: 'Machines', ch: '○'},
		{e: 'gear_assembly', n: 'Gear Assembly', c: 'Machines', ch: '☼'},
		{e: 'floodgate', n: 'Floodgate', c: 'Machines', inv: true, ch: 'X'}
	],
	workshop_type: [
