window.enums = {
	...
	layout_type: [
		...
		{e: 'bed', n: 'Bed', c: 'Furniture', mr: true},
		{e: 'chair', n: 'Chair', c: 'Furniture', mr: true},
		{e: 'table', n: 'Table', c: 'Furniture', mr: true},
		{e: 'statue', n: 'Statue', c: 'Furniture', mr: true},
		{e: 'chest', n: 'Chest', c: 'Storage', mr: true},
		{e: 'cabinet', n: 'Cabinet', c: 'Storage', mr: true},
		{e: 'bookcase', n: 'Bookcase', c: 'Storage'},
		{e: 'archery_target', n: 'Archery Target', c: 'Military'},
		{e: 'armor_stand', n: 'Armor Stand', c: 'Military', mr: true},
		{e: 'weapon_rack', n: 'Weapon Rack', c: 'Military', mr: true},
		{e: 'cage', n: 'Cage', c: 'Restraints', mr: true},
		{e: 'restraint', n: 'Chain', c: 'Restraints', mr: true},
		{e: 'hive', n: 'Hive', c: 'Farm'},
		{e: 'nest_box', n: 'Nest Box', c: 'Farm'},
		{e: 'coffin', n: 'Coffin', c: 'Utilities', mr: true},
		{e: 'traction_bench', n: 'Traction Bench', c: 'Utilities'},
		{e: 'well', n: 'Well', c: 'Utilities', mr: true},
